...
<p align="center">
<h4>Lab Topology:</h4>
In this lab there are 2 networks, the "INSIDE NETWORK" and the "OUTSIDE NETWORK". The goal is to make the "INSIDE NETWORK" communcate with the "OUTSIDE NETWORK", with the "INSIDE NETWORK" using private addressing translated into public adresses using NAT.<br/><br/>
...
The "INSIDE NETWORK" has bought the range of public addreses 220.0.0.0/28<br/>
...
To do this, an access list is created to permit the 10.10.20.0 subnet and NAT is enabled for the subnet using the g0/0 interface.<br/>
